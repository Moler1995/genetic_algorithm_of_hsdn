...
class NearOptUpgradeStrategyWithDeterminedWeight(ea.Problem):
        ...
        for i in range(self.node_count):
            ...
            for index in range(self.node_count):
                total_bandwidth_used += self.solve_sub_problem_one_node(index, filled_weight_list,
                                                                        shortest_path_list, sdn_nodes, self.traffics)
    ...
    def solve_sub_problem_one_node(self, i, filled_weight_list, shortest_path_list, sdn_nodes, traffics):
        ...
        near_optimal_bandwidth_used = nosr.execute(dag, sorted_nodes, traffics, self.band_width, sdn_nodes, True)
